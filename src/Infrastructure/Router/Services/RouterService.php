...
namespace MbcApiContent\Infrastructure\Router\Services;
...
use MbcApiContent\Infrastructure\Api\Models\Collections\ModelRouteCollection;
...
class RouterService implements RouterServiceInterface
{
    ...
    public  ModelRouteCollectionInterface $routesLaravelCollection;

    public function __construct()
    {
        $this->routesModelCollection = new EloquentCollection();
        $this->routesLaravelCollection = new ModelRouteCollection();
