...
Route::get('/', ['uses' =>  'MbcApiContent\Infrastructure\BackOffice\Http\Controllers\Bo\BoController@index']);
Route::get('/wysiwyg', ['uses' => 'MbcApiContent\Infrastructure\BackOffice\Http\Controllers\Bo\BoController@wysiwyg']);
